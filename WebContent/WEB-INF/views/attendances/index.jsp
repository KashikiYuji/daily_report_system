...
<c:import url="../layout/app.jsp">
    <c:param name="content">
        ...
        <table id="attendance_list">
         <tbody>
                <tr>
                    ...
                    <th class="attendance_gtime">出勤時間</th>
                    <th class="attendance_ftime">退勤時間</th>
                </tr>
                <c:forEach var="attendance" items="${attendances}" varStatus="status">
                    <tr class="row${status.count % 2}">
                        ...
                        <td class="attendance_date">${attendance.attendance_date}</td>
                        <td class="go_time">${attendance.gtime_at}</td>
                        <td class="leave_time">${attendance.ftime_at}</td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
        ...
        <p><a href="<c:url value='/attendances/new' />">出退勤の登録</a></p>
        </c:param>
</c:import>